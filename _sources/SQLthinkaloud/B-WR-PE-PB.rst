...
.. activecode:: hparsons_ta_sql_practice_0_wr_b
    :language: sql
    :showlastsql:
...
.. hparsons:: hparsons_ta_sql_practice_1_pe_b
    :language: sql
    :randomize:
...
.. hparsons:: hparsons_ta_sql_practice_2_pb_b
    :language: sql
    :randomize:
...
.. activecode:: hparsons_ta_sql_practice_3_wr_b
    :language: sql
    :showlastsql:
...
.. hparsons:: hparsons_ta_sql_practice_4_pe_b
    :language: sql
    :randomize:
...
.. hparsons:: hparsons_ta_sql_practice_5_pb_b
    :language: sql
    :randomize:
